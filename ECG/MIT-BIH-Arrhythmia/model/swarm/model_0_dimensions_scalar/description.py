...
config ={
  'modelParams' : {'sensorParams': {'encoders': {'ecg': {'maxval': 1311, 'name': 'ecg', 'minval': 850, 'type': 'ScalarEncoder', 'fieldname': 'ecg', 'w': 51, 'resolution': 0.2}}}, 'spParams': {'columnCount': 2048}, 'tpParams': {'columnCount': 2048, 'pamLength': 1800, 'cellsPerColumn': 16}},
